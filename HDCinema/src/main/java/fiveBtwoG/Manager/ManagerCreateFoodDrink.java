...
@WebServlet("/createFoodDrink")
public class ManagerCreateFoodDrink extends HttpServlet {
	@Override
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException{
		
		//Get text input data from the request
		...
		if(FoodDrink.createFoodDrink(itemID, name, size, description, price,type)== true) {
